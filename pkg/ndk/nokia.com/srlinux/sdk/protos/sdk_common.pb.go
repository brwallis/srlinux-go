...
func (SdkMgrStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_sdk_common_proto_enumTypes[8].Descriptor()
}

func (SdkMgrStatus) Type() protoreflect.EnumType {
	return &file_sdk_common_proto_enumTypes[8]
}
...
type EvpnEthSegIdPb struct {
	...
	Id []byte `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` //Type 0 for now. hard-coded id
}

func (x *EvpnEthSegIdPb) Reset() {
	*x = EvpnEthSegIdPb{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sdk_common_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EvpnEthSegIdPb) Descriptor() ([]byte, []int) {
	return file_sdk_common_proto_rawDescGZIP(), []int{11}
}

func (x *EvpnEthSegIdPb) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
var file_sdk_common_proto_rawDesc = []byte{
	...
	0x53, 0x74, 0x72, 0x22, 0x20, 0x0a, 0x0e, 0x45, 0x76, 0x70, 0x6e, 0x45, 0x74, 0x68, 0x53, 0x65,
	0x67, 0x49, 0x64, 0x50, 0x62, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x02, 0x69, 0x64, 0x2a, 0x66, 0x0a, 0x0b, 0x49, 0x66, 0x4d, 0x67, 0x72, 0x49, 0x66,
	...
	0x06, 0x2a, 0xbb, 0x05, 0x0a, 0x10, 0x49, 0x66, 0x4f, 0x70, 0x65, 0x72, 0x44, 0x6f, 0x77, 0x6e,
	...
	0x50, 0x45, 0x52, 0x5f, 0x44, 0x4f, 0x57, 0x4e, 0x5f, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x5f, 0x41,
	0x44, 0x4d, 0x49, 0x4e, 0x5f, 0x44, 0x49, 0x53, 0x41, 0x42, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x12,
	...
	0x42, 0x45, 0x52, 0x5f, 0x52, 0x45, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45, 0x53, 0x10, 0x13, 0x2a,
	...
	0x01, 0x42, 0x1e, 0x5a, 0x1c, 0x6e, 0x6f, 0x6b, 0x69, 0x61, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73,
...
var file_sdk_common_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
var file_sdk_common_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
...
func file_sdk_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sdk_common_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
