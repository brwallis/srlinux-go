...
go run $YGOT_DIR/generator/generator.go \
   -path=${SRL_SRC_PATH}/ -output_file=${GO_OUT_PATH}/model.go -package_name=srl_yang -generate_fakeroot \
   ...
   ${SRL_SRC_PATH}/interfaces/srl_nokia-interfaces-ip-dhcp-server.yang \
   ...
   ${SRL_SRC_PATH}/platform/srl_nokia-platform-vxdp.yang \
   ...
   ${SRL_SRC_PATH}/system/srl_nokia-dhcp-server.yang \
